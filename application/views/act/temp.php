...
<div class="bdcont_100">
	<div class="bc__box100">
		...
		<header>
			total : <?php echo $num;?>
			<span class="btn print excel_update"><i class="material-icons">get_app</i>등록실행</span> 
			<span class="btn print excel_cancel" style="margin-right:5px;"><i class="material-icons">close</i>취소</span> 
		</header>
		...
		<div class="tbl-content">
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				...
				?>
					...
					<tr>
						<td colspan="17" class="list_none">임시데이터가 없습니다.</td>
					</tr>
...
$(".excel_cancel").on("click",function(){
	if(confirm("임시데이터를 삭제하시겠습니까?") !== false){
		$.post("<?php echo base_url('act/temp_cancel')?>",{mode:'cancel'},function(data){
			location.href="<?php echo base_url('act')?>";
		});
	}
});
