				...
				<table class="none_border" cellpadding="0" cellspacing="0" border="0" width="100%">
					<tbody>
						<tr>
							<th>은행명</th>
							<td>
								<input type="text" name="BANKNAME" id="BANKNAME" value="<?php echo isset($memInfo)?$memInfo->BANKNAME:"";?>" class="form_input">
							</td>
							<th>계좌번호</th>
							<td>
								<input type="text" name="BANKNUM" id="BANKNUM" value="<?php echo isset($memInfo)?$memInfo->BANKNUM:"";?>" class="form_input">
							</td>
						</tr>
						<tr>
							<th>예금주</th>
							<td colspan="3">
								<input type="text" name="BANKOWN" id="BANKOWN" value="<?php echo isset($memInfo)?$memInfo->BANKOWN:"";?>" class="form_input">
							</td>
						</tr>
