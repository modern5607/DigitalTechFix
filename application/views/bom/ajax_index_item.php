...
?>
<form name="itemsform" id="itemsform" method="post" action="<?php echo base_url('mdm/itemsUpdate');?>" onsubmit="return itemsformchk(this)">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo (!empty($bomInfo))?$bomInfo->INSERT_DATE:date("Y-m-d H:i:s",time()); ?></td>
					<th class="w120">등록자</th>
					<td><?php echo (!empty($bomInfo))?$bomInfo->INSERT_ID:$this->data['userName'];?></td>
				</tr>
