...
<div class="bdcont_100">
    <div class="bc__box100">
        <header style="height:unset;">
			...
			<button class="search_submit" style="font-size: 20px; padding: 10px; margin: 20px;" onclick="location.href='<?=base_url('vrel/rass');/*새로고침 버튼*/?>'"><i class="material-icons">cached</i></button>
