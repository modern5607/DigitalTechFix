				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="radio" name="USE_YN" value="Y" <?php echo (isset($data->USE_YN) && ($data->USE_YN == "Y"))?"checked":"";?> id="enable" class="form_input"><label for="enable">사용</label>
								<input type="radio" name="USE_YN" value="N" <?php echo (isset($data->USE_YN) && ($data->USE_YN == "N"))?"checked":"";?> id="unable" class="form_input"><label for="unable">사용안함</label>
							</td>
						</tr>
						<tr>
