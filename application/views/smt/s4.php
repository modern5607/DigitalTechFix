            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                ...
                <tbody>
                    ...
                    foreach ($actList as $i => $row) {
                        ...
                        $disabled = ($row->FINISH == 'Y') ? "" : "link_s1 mline_btn";        //출고완료 or 제작완료된 SMT는 생산LINE 링크 비활성화
                    ...
                    ?>
                        <tr <?php echo $bg; ?>>
                            ...
                            <td class="cen"><span class="<?= $disabled ?>" data-idx="<?php echo $row->IDX; ?>" data-blno="<?php echo $row->BL_NO; ?>">
                                    <?php
                                    if (empty($row->M_LINE))
                                        echo "할당안됨";
                                    else
...
<script>
    ...
    $(document).on("click", ".printxx", function() {
        ...
        $.post("<?php echo base_url('smt/ajax_mline_update') ?>", {
            idx: idx,
            mline: mline
        }, function(data) {
            if (data > 0) {
