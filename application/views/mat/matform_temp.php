...
<div class="bdcont_100">
	<div class="bc__box100">
		...
		<header>
			...
			<span class="btn print excel_cancel" style="margin-right:5px;"><i class="material-icons">close</i>삭제</span> 
		</header>
...
$(".excel_cancel").on("click",function(){
	if(confirm("임시데이터를 삭제하시겠습니까?") !== false){
		$.post("<?php echo base_url('mat/matform_temp_cancel')?>",{mode:'cancel'},function(data){
			location.href="<?php echo base_url('mat/matform')?>";
		});
	}
});
